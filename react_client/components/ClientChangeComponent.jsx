...
class ClientChangeComponent extends Component {
    constructor(props) {
        super(props);
    ...
    async handleSubmit(e) {
        ...
        if (this.state.nameValid &&
            ...
            const response = await fetch(`http://localhost:5000/client/${this.props.profile._id}/update`, {
                method: "PUT",
                headers: {
...
export default ClientChangeComponent;